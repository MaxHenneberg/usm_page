...
function CoverImageComponent(props) {
    ...
    return (
        <div className="mainImage">
            ...
            <div className="hover">
                <Image src={lineHayatLogo} width="100%" height="100%" className="lHLogo"/>
                    ...
                    <div className="buttonContainer">
                        ...
                        <Link to='aboutus'>
                            <Button variant="secondary"
                                    className="float-md-left">{languageContext.content.home.callUs}</Button>
                        </Link>
                    </div>
                </div>
            </div>
            <div className="courtesyText">Image courtesy of Meda and Public Relations Centre, USM</div>
        </div>
    )
}
