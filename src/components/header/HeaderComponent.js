              ...
              <Navbar expand="md" fixed="top" className="justify-content-between header" expanded={expanded} onToggle={() => setExpanded(!expanded)}>
                ...
                <NavbarCollapse id="basic-navbar-nav" className="justify-content-between">
                  <Nav className="mr-auto" onSelect={() => setExpanded(!expanded)}>
                    <NavDropdown className='text-uppercase' title={languageContext.content.header.whoWeAre} id="basic-nav-dropdown">
                    ...
                    <NavDropdown className='text-uppercase' title={languageContext.content.header.helped} id="basic-nav-dropdown">
                    ...
                    <NavLink className='text-uppercase' href='#/volunteer' target="_blank">{languageContext.content.header.volunteer}</NavLink>
                    <NavLink className='text-uppercase' href="#/action/3.2">{languageContext.content.header.support}</NavLink>
                    <NavLink className='text-uppercase' href="#/resources">{languageContext.content.header.resources}</NavLink>
                    <NavLink className='text-uppercase' href="/#faq">FAQ</NavLink>
                    <NavDropdown className='text-uppercase' title="Our Contacts" id="basic-nav-dropdown">
