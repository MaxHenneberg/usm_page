  ...
  return (
      <div className="footer">
        ...
        <div className="horizontalCenter footerDesignedBy">
            <p className="footerDesignedByNoMargin">Designed by <span className="footerHighlight">LineHayat D&M</span>;</p><p>Developed by <a href="https://henneberg.io/#/" target="_blank" rel="noopener noreferrer" className="myLink"><span className="footerHighlight">Max Henneberg</span></a> & <span className="footerHighlight">Joo Hom</span></p>
        </div>
      </div>
  )
}
